...
class DET:
    ...
    def create_figure(self):
        ...
        """
        self.figure = mpl.figure(figsize=(20,20))
        ...
        ax.set_xticklabels(self.x_ticklabels, size='x-large')

        ax.set_yticks(self.axes_transform(self.y_ticks))
        ax.set_yticklabels(self.y_ticklabels, size='x-large')
    ...
    def save(self, filename, type='tikz', dpi=None, width='200pt', height='200pt'):
        if type in ['pdf', 'png']:
